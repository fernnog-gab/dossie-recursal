...
function injectGlobalStyles() {
    ...
    style.textContent = `
        :root {
            --text-sub: #475569; /* Escurecido de #64748b para melhor leitura em fundos claros */
        }
        body { 
        ...
        /* Otimização de Espaço com Grid Layout */
        .rep-grid { 
            display: grid; 
        ...
        /* Alinhamento de Tags e Layout da Linha */
        .checklist-item { 
            display: flex; 
            align-items: center; 
        ...
        /* Microinterações e Affordance (Drag Handle) */
        .drag-handle {
            cursor: grab;
            color: #94a3b8;
            margin-right: 12px;
...
function renderContent(data) {
    ...
    // Adiciona a classe Grid ao container de representação para o Ponto B do plano
...
function addNewTopic() {
    ...
    div.innerHTML = `
        ...
        <input type="checkbox" class="chk-input" onchange="toggleRow(this); autoSave();">
        <div class="item-content">
            <input type="text" class="item-title-input" placeholder="Digite o nome do tópico..." oninput="this.setAttribute('value', this.value); autoSave();">
        </div>
        <span class="badge badge-author" onclick="rotateBadge(this);" title="Clique para alternar entre AUTOR, RÉU e AMBOS">AUTOR</span>
        <button onclick="this.parentElement.remove(); autoSave();" style="border:none; background:none; cursor:pointer; color:#cbd5e1; margin-left: 8px; font-size: 1.1rem;" title="Remover Tópico">✕</button>
    `;
