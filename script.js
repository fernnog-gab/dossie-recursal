...
function renderContent(data) {
    ...
    if(data.topicos_do_recurso && Array.isArray(data.topicos_do_recurso)) { 
        data.topicos_do_recurso.forEach(topic => {
            ...
            // REMOVIDO o autoSave() do onchange
            topicContainer.innerHTML += `
...
// --- 3. INICIALIZAÇÃO LIMPA (SEM PERSISTÊNCIA LOCAL) ---
...
// REMOVIDO o autoSave() dos inlines onchange e oninput
...
// REMOVIDO o autoSave() dos inlines
function addNewObs() {
...
function addNewTopic() {
    ...
    div.innerHTML = `
        ...
        <button onclick="this.parentElement.remove();" style="border:none; background:none; cursor:pointer; color:#cbd5e1; margin-left: 8px; font-size: 1.1rem;" title="Remover Tópico">✕</button>
    `;
...
// --- 5. EXPORTAÇÃO COMPLETA (MANTIDA INTACTA PARA O APPS SCRIPT LER) ---
